    ...
    <div className={`content ${DarkTheme && "dark"}`}>
      ...
      <div className="row side-rect">
        <section>
          ...
          <div className="more-details">
            <h1 className="title">ການຮັບຄໍາຮ້ອງຂໍເຄື່ອນໄຫວ Invoice</h1>
            <span className="txt">
              ເປີເຊັນ ການຮັບຄໍາຮ້ອງຂໍເຄື່ອນໄຫວທີ່ດິນ ທີ່ຍັງດໍາເນີນການພາຍໃນລະບົບ ເຊີ່ງເປັນຕົວຊີ້ວັດໜຶ່ງໃນການວິເຄາະການປະຕິບັດວຽກງານຂອງອົງກອນ.
            </span>
          </div>
        </section>
      </div>
      <div className="row side-rect">
        <section>
          ...
          <div className="more-details">
            <h1 className="title">ການແຈກຍາຍເອກະສານຢັ້ງຢືນ Receive</h1>
            <span className="txt">
              ເປີເຊັນ ການສໍາເລັດການແຈກຍາຍເອກະສານທີ່ດິນ ທີ່ສົມບູນພາຍໃນລະບົບ ເຊີ່ງເປັນຕົວຊີ້ວັດໜຶ່ງໃນການວິເຄາະການປະຕິບັດວຽກງານຂອງອົງກອນ.
            </span>
          </div>
        </section>
      </div>
